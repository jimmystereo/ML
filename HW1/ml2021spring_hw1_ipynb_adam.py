# -*- coding: utf-8 -*-
"""ML2021Spring - HW1.ipynb adam

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1WEVoJoghlgajuqTmEXdZN6gKvHHg9U4G
...
#     writer.writerow(['learning_rate','batch_size','rmse','second'])
...
## **Training**
"""
learning_rate = list(np.arange(0.0101,0.1,0.005))
batch_size = list(np.arange(5,200,10,dtype='int64'))
# learning_rate =
...
for lr in learning_rate:
    for bs in batch_size:
        ...
        config = {
            ...
            'batch_size': int(bs),               # mini-batch size for dataloader
        ...
        rmse = plot_pred(dv_set, model, device)  # Show prediction on the validation set
        ...
        with open('pred.csv','r') as fp:
            second = list(csv.reader(fp))[2][1]
            with open('result.csv','a') as res:
                writer = csv.writer(res)
                writer.writerow([lr,bs,rmse,second])
