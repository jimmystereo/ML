...
config = {'learning_rates': 0.001,
          'batch_size': 429, 'val_ratio': 0.4, 'epoch': 1, 'alpha': 0.0001}
...
optimizer = torch.optim.Adam(
    model.parameters(), lr=float(learning_rate), weight_decay=config['alpha'])
...
#     if(predict[i-1, 1] == predict[i+1, 1]):
...
with open(file_name, 'a') as f:
    f.write('{},{},{},{},{},{}\n'.format(
        learning_rate, BATCH_SIZE, VAL_RATIO, acc, num_epoch, config['alpha']))
